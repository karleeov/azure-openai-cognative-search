...
AZURE_OPENAI_CHATGPT_35_DEPLOYMENT = "chat3-5"
...
async def setup_clients():
    ...
    search_client = SearchClient(
        endpoint=f"https://{AZURE_SEARCH_SERVICE}.search.windows.net",
        index_name="testingindex2",
        credential=azure_credential)
    vpg_testcase1_search_client = SearchClient(
        endpoint=f"https://{AZURE_SEARCH_SERVICE}.search.windows.net",
        index_name="vpg-testcase1-index",
        credential=azure_credential)
    vpg_testcase2_search_client = SearchClient(
        endpoint=f"https://{AZURE_SEARCH_SERVICE}.search.windows.net",
        index_name="vpg-testcase2-index",
        credential=azure_credential)
    vpg_testcase3_search_client = SearchClient(
        endpoint=f"https://{AZURE_SEARCH_SERVICE}.search.windows.net",
        index_name="vpg-testcase3-index",
        credential=azure_credential)
    vpg_testcase3_csv_search_client = SearchClient(
        endpoint=f"https://{AZURE_SEARCH_SERVICE}.search.windows.net",
        index_name="vpg-testcase3-csv-index",
        credential=azure_credential)
    vpg_testcase4_search_client = SearchClient(
        endpoint=f"https://{AZURE_SEARCH_SERVICE}.search.windows.net",
        index_name="vpg-testcase4-index",
        credential=azure_credential)
    vpg_testcase4_csv_search_client = SearchClient(
        endpoint=f"https://{AZURE_SEARCH_SERVICE}.search.windows.net",
        index_name="vpg-testcase4-csv-index",
        credential=azure_credential)
    testing_skillset_search_client = SearchClient(
        endpoint=f"https://{AZURE_SEARCH_SERVICE}.search.windows.net",
        index_name="testing-skillset-index",
        credential=azure_credential)
    vpg_testcase5_search_client = SearchClient(
        endpoint=f"https://{AZURE_SEARCH_SERVICE}.search.windows.net",
        index_name="vpg-testcase5-index",
        credential=azure_credential)
    ctf_search_client = SearchClient(
        endpoint=f"https://{AZURE_SEARCH_SERVICE}.search.windows.net",
        index_name="ctf-index",
        credential=azure_credential)
    hkstp_search_client = SearchClient(
        endpoint=f"https://{AZURE_SEARCH_SERVICE}.search.windows.net",
        index_name="cosmosdb-index2",
        credential=azure_credential)
    hkhs_search_client = SearchClient(
        endpoint=f"https://{AZURE_SEARCH_SERVICE}.search.windows.net",
        index_name="hkhsindex",
        credential=azure_credential)
    ...
    current_app.config[CONFIG_CHAT_APPROACHES] = {
        "rrr": ChatReadRetrieveReadApproach(
            search_client,
            hkhs_search_client,
            vpg_testcase1_search_client,
            vpg_testcase2_search_client,
            vpg_testcase3_search_client,
            vpg_testcase3_csv_search_client,
            vpg_testcase4_search_client,
            vpg_testcase4_csv_search_client,
            vpg_testcase5_search_client,
            testing_skillset_search_client,
            ctf_search_client,
            hkstp_search_client,
            AZURE_OPENAI_CHATGPT_DEPLOYMENT,
